...
public class TestBuilder2 {
  ...
  private int expectedNumBatches = DremioTestWrapper2.EXPECTED_BATCH_COUNT_NOT_SET;
  private Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineValuesForTDigestMap;
  private Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap;

  public TestBuilder2(BufferAllocator allocator) {
    this.allocator = allocator;
    reset();
  }

  public TestBuilder2(BufferAllocator allocator, Object query, QueryType queryType, Boolean ordered,
                      ...
                      int expectedNumBatches, Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineValuesForTDigestMap,
                      Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap) {
    this(allocator);
    if (ordered == null) {
  ...
  public DremioTestWrapper2 build() throws Exception {
    ...
    return new DremioTestWrapper2(this, allocator, query, queryType, baselineOptionSettingQueries, testOptionSettingQueries,
  ...
  public TestBuilder2 sqlQuery(String query) {
    this.query = QueryTestUtil.normalizeQuery(query);
    this.queryType = QueryType.SQL;
    return this;
  }

  public TestBuilder2 sqlQuery(String query, Object... replacements) {
    return sqlQuery(String.format(query, replacements));
  }

  public TestBuilder2 preparedStatement(PreparedStatementHandle preparedStatementHandle) {
    queryType = QueryType.PREPARED_STATEMENT;
    query = preparedStatementHandle;
    return this;
  }

  public TestBuilder2 sqlQueryFromFile(String queryFile) throws IOException {
  ...
  public TestBuilder2 physicalPlanFromFile(String queryFile) throws IOException {
    String query = BaseTestQuery2.getFile(queryFile);
    this.query = query;
    this.queryType = QueryType.PHYSICAL;
    return this;
  }

  public TestBuilder2 ordered() {
    this.ordered = true;
    return this;
  }

  public TestBuilder2 unOrdered() {
    this.ordered = false;
    return this;
  }
  ...
  // large on-heap lists
  public TestBuilder2 highPerformanceComparison() throws Exception {
  ...
  public TestBuilder2 optionSettingQueriesForBaseline(String queries) {
    this.baselineOptionSettingQueries = queries;
    return this;
  }

  public TestBuilder2 optionSettingQueriesForBaseline(String queries, Object... args) {
  ...
  // list takes the form of a semi-colon separated list
  public TestBuilder2 optionSettingQueriesForTestQuery(String queries) {
    this.testOptionSettingQueries = queries;
    return this;
  }

  public TestBuilder2 optionSettingQueriesForTestQuery(String query, Object... args) throws Exception {
    this.testOptionSettingQueries = String.format(query, args);
    return this;
  }

  public TestBuilder2 approximateEquality() {
  ...
  protected QueryType getValidationQueryType() throws Exception {
  ...
  public TestBuilder2 baselineTypes(Map<SchemaPath, MajorType> baselineTypeMap) {
    this.baselineTypeMap = baselineTypeMap;
    return this;
  }
  ...
  public TestBuilder2 expectsEmptyResultSet() {
    unOrdered();
   ...
   */
  public TestBuilder2 expectsNumBatches(int expectedNumBatches) {
    this.expectedNumBatches = expectedNumBatches;
    return this;
  }
  /**
   ...
   * @return
   */
  public TestBuilder2 baselineValues(Object ... baselineValues) {
  ...
  public TestBuilder2 baselineTolerancesForTDigest(Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineValuesForTDigestMap) {
    this.baselineValuesForTDigestMap = baselineValuesForTDigestMap;
    return this;
  }

  public TestBuilder2 baselineTolerancesForItemsSketch(Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap) {
    this.baselineValuesForItemsSketchMap = baselineValuesForItemsSketchMap;
    return this;
  }
   ...
   * @return
   */
  public TestBuilder2 baselineRecords(List<Map<String, Object>> materializedRecords) {
   ...
   */
  public TestBuilder2 baselineColumns(String... columns) {
  ...
  public BaselineQueryTestBuilder sqlBaselineQuery(Object baselineQuery) {
    return new BaselineQueryTestBuilder(baselineQuery, QueryType.SQL, allocator, query, queryType, ordered, approximateEquality,
  ...
  public BaselineQueryTestBuilder physicalPlanBaselineQueryFromFile(String baselinePhysicalPlanPath) throws IOException {
    ...
    return new BaselineQueryTestBuilder(baselineQuery, QueryType.PHYSICAL, allocator, query, queryType, ordered, approximateEquality,
      baselineTypeMap, baselineOptionSettingQueries, testOptionSettingQueries, highPerformanceComparison, expectedNumBatches, baselineValuesForTDigestMap, baselineValuesForItemsSketchMap);
  }
  ...
  public class CSVTestBuilder extends TestBuilder2 {
    ...
    CSVTestBuilder(String baselineFile, BufferAllocator allocator, Object query, QueryType queryType, Boolean ordered,
                   boolean approximateEquality, Map<SchemaPath, MajorType> baselineTypeMap,
                   String baselineOptionSettingQueries, String testOptionSettingQueries, boolean highPerformanceComparison,
                   int expectedNumBatches, Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineTolerances,
                   Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap) {
  ...
  public class SchemaTestBuilder extends TestBuilder2 {
    private List<Pair<SchemaPath, MajorType>> expectedSchema;

    SchemaTestBuilder(BufferAllocator allocator, Object query, QueryType queryType,
    ...
    @Override
    public TestBuilder2 baselineValues(Object... objects) {
      assert false : "Since only schema will be compared in this test, no record is expected";
      return this;
    }
  ...
  public class JSONTestBuilder extends TestBuilder2 {

    // path to the baseline file that will be inserted into the validation query
    private String baselineFilePath;

    JSONTestBuilder(String baselineFile, BufferAllocator allocator, Object query, QueryType queryType, Boolean ordered,
                    boolean approximateEquality, Map<SchemaPath, MajorType> baselineTypeMap,
                    String baselineOptionSettingQueries, String testOptionSettingQueries, boolean highPerformanceComparison,
                    int expectedNumBatches, Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineTolerances,
                    Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap) {
  ...
  public class BaselineQueryTestBuilder extends TestBuilder2 {
    ...
    BaselineQueryTestBuilder(Object baselineQuery, QueryType baselineQueryType, BufferAllocator allocator,
                             Object query, QueryType queryType, Boolean ordered,
                             boolean approximateEquality, Map<SchemaPath, MajorType> baselineTypeMap,
                             String baselineOptionSettingQueries, String testOptionSettingQueries, boolean highPerformanceComparison,
                             int expectedNumBatches, Map<String, DremioTestWrapper2.BaselineValuesForTDigest> baselineTolerances,
                             Map<String, DremioTestWrapper2.BaselineValuesForItemsSketch> baselineValuesForItemsSketchMap) {
